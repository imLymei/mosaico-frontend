  ...
  <div class="flex" style="height: 100vh">
    ...
    <div class="flex-1">
      ...
      ">
        ...
        <form class="flex-col" style="gap: 1rem; min-width: 20vw">
          <div class="flex-col">
            <label for="username-input">
              Username
            </label>
            <input id="username-input" required style="padding: 0.25rem;"/>
          </div>
          <div class="flex-col">
            <label for="username-input">
              Password
            </label>
            <input id="username-input" required type="password" style="padding: 0.25rem;"/>
          </div>
          <button type="submit" style="padding: 0.25rem;">
            Login
          </button>
        </form>
        <button onclick="redoWelcome()" style="padding: 0.25rem;">Redo Welcome</button>
      </div>
    </div>
  </div>
`;
